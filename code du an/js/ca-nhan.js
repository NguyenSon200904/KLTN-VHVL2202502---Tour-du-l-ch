...
document.addEventListener('DOMContentLoaded', async function () {
  var u = loadUser();
  if (!u) { window.location.href = 'dang-nhap.html'; return; }
  initNav();
  try {
...
async function cpRenderHistory(u) {
  ...
  if (!bookings.length) {
    list.innerHTML = '<div class="cp-empty"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#ddd" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg><p>Bạn chưa có lịch sử đặt tour nào.</p><a href="tour-du-lich.html" class="cp-explore-btn">Khám phá ngay</a></div>';
    return;
  }
